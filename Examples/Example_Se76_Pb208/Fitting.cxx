...
void RunFitter(const char* nuclfile = "NucleusFile.txt", const char* datafile = "Data.txt", const int threads = 1){
...
q		//	A temporary ExperimentData object is created, to push back into the vector
		...
		poinVec.push_back(expts->GetClonePointCalculation(e));						//	Get the PointCalculation from the Experiment object. This is at the average theta/energy.
		poinVec.at(e)->WriteDetailsToFile(fname);												//	Write the details of the calculation
	}
	std::cout << std::endl;
